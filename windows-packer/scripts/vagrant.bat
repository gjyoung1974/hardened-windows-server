...
if not defined VAGRANT_PUB_URL set VAGRANT_PUB_URL=https://github.com/gjyoung1974/hardened-windows-server/blob/master/windows-packer/scripts/vagrant.pub
